...
/**
 * Modified main runtime to remove any restrictions on the App Engine Sandbox.
 *
 */
public class Runtime {
    ...
    private static final Set<String> blackList =
            (Set<String>) invokeMethod(agent, "getBlackList", new Class<?>[0], new Object[0]);
    ...
    public static void recordClassLoader(ClassLoader loader) {
        invokeMethod(
                agent, "recordAppClassLoader", new Class<?>[] {ClassLoader.class}, new Object[] {loader});
    }

    public static void reject(String className) {
        //do not reject the class - simply do nothing.
    }
    ...
    public static void checkRestricted(boolean violationIsError, String classStr,
        ...
        if (System.getProperty("appengine.disableRestrictedCheck") == null) {
            RuntimeHelper.checkRestricted(
                    violationIsError, classStr, callingClassStr, callingClassCodeSource);
        }
    }

    private static Object invokeMethod(
            Object instance, String methodName, Class<?>[] argTypes, Object[] args) {
        try {
    ...
    public static Object invoke(Method method, Object target, Object[] args) throws
        ...
        checkAccess(method, target, getImmediateCallerClassPrivileged());
